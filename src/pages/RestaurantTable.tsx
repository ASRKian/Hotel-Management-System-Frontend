...
export function RestaurantTables() {
    ...
    const { data } = useGetRestaurantTableQuery({ propertyId: selectedPropertyId, page }, {
    ...
    const createTable = () => {
        const payload = buildCreateTablePayload(form);
    ...
    const updateTableStatus = (tableId: string, status: string) => {
        ...
        // console.log("UPDATE STATUS", tableId, payload);
                            ...
                            >
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Min Order: ₹{table.min_order_amount}
                                    </p>
                                </div>
